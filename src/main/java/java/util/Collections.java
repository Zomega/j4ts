...
public class Collections {
  ...
  /*
   * These methods are commented out because they cannot currently be implemented
   * in GWT. The signatures are included in case that changes.
   */
  ...
  public static <T> int binarySearch(
    ...
    /*
     * TODO: This doesn't implement the "iterator-based binary search" described in
     * the JDK docs for non-RandomAccess Lists. Until GWT provides a LinkedList,
  ...
  public static <T> Comparator<T> reverseOrder() {
    return (Comparator<T>) any(ReverseComparator.INSTANCE);
  }
