...
public class Pattern implements Serializable {
  ...
  private static class GroupNameRemover implements Function<def.js.String[], def.js.String> {
    ...
    public def.js.String apply(def.js.String[] args) {
      ...
      if (inBrackets || args[2] != undefined) { // only close bracket saves out from this state
        inBrackets =
            args[2] == undefined || args[2].length == 1; // keep in brackets if not close or escaped
        return args[0];
      }
      if (args[1] != undefined) {
  ...
  public static Pattern compile(String regexpString, int flags) {
    ...
    Supplier<def.js.String> mapper =
        Lang.<Supplier<def.js.String>>any(
            (Function<def.js.String[], def.js.String>)
                ((def.js.String... args) -> {
                  ...
                  boolean hasOpenBracket =
                      (startIndexOfMatched > 0
                              && "(".equals(string(regexp.charAt(startIndexOfMatched - 1))))
                          || (startIndexOfMatched > 2
                              && "(?:".equals(string(regexp.substr(startIndexOfMatched - 3, 3))));
                  boolean hasCloseBracket =
                      regexp.length > endIndexOfMatched
                          && ")".equals(string(regexp.charAt(endIndexOfMatched)));
