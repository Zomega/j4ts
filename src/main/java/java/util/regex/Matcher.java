...
public class Matcher implements MatchResult {
  ...
  private boolean searchWith(RegExp regExp) {
    ...
    NonCapturesToCaptures nonCapturesToCaptures =
        new NonCapturesToCaptures(parenthesisStart, parenthesisEnds);

    String regExpStringWithAllCaptures =
        string(
    ...
    IndexGetter indexGetter =
        new IndexGetter(
            regExp.source, parenthesisStart, parenthesisEnds, starts, ends, startLastIndex);
    string(text.substring(startLastIndex))
        .replace(
            regExpWithAllCaptures,
            Lang.<Supplier<def.js.String>>any(
                (Function<def.js.String[], def.js.String>)
        ...
        string(
            string(text)
                .replace(
                    ...
                    Lang.<Supplier<def.js.String>>any(
                        (Function<def.js.String[], def.js.String>)
                            ((def.js.String[] args) -> firstReplacer.apply(args)))));
