...
public class LinkedList<E> extends AbstractSequentialList<E>
  ...
  private final class DescendingIteratorImpl implements Iterator<E> {
    private final ListIterator<E> itr = new ListIteratorImpl2(size, tail);
  ...
  private final class ListIteratorImpl2 implements ListIterator<E> {
     ...
     */
    public ListIteratorImpl2(int index, Node<E> startNode) {
  ...
  public ListIterator<E> listIterator(final int index) {
    ...
    return new ListIteratorImpl2(index, node);
  }
