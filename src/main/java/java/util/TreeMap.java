...
public class TreeMap<K, V> extends AbstractNavigableMap<K, V> implements Serializable {
  ...
  static final SubMapType SubMapType_Head = new SubMapTypeHead();
  ...
  public NavigableMap<K, V> headMap(K toKey, boolean inclusive) {
    return new SubMap(SubMapType_Head, null, false, toKey, inclusive);
  }
  ...
  public NavigableMap<K, V> tailMap(K fromKey, boolean inclusive) {
    return new SubMap(SubMapType_Tail, fromKey, inclusive, null, false);
  }
