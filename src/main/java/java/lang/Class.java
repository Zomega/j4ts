...
public final class Class<T> implements Type {
  ...
  private static <T> Class<?> getClassLiteralForArray(Class<T> leafClass, int dimensions) {
    Class<?>[] arrayLiterals =
        leafClass.arrayLiterals =
            leafClass.arrayLiterals == null ? new Class<?>[0] : leafClass.arrayLiterals;
    return arrayLiterals[dimensions] != null
   ...
   */
  @DoNotInline
  static <T> Class<T> createForClass(
      String packageName, String compoundClassName, String typeId, Class<? super T> superclass) {
   ...
   */
  @DoNotInline
  static <T> Class<T> createForEnum(
      String packageName,
      String compoundClassName,
      String typeId,
      Class<? super T> superclass,
      def.js.Function enumConstantsFunc,
  ...
  private static <T> Class<T> createClassObject(
      String packageName, String compoundClassName, String typeId) {
   ...
   *
   * <p>If the prototype for typeId has not yet been created, then install the literal into a
  ...
  public T[] getEnumConstants() {
    return $insert("this.enumConstantsFunc && (this.enumConstantsFunc)()");
  }
