...
public final class DoubleHelper extends NumberHelper implements Comparable<DoubleHelper> {
  ...
  // 2^512, 2^-512
  public static final double POWER_512 = 1.3407807929942597E154;
  public static final double POWER_MINUS_512 = 7.458340731200207E-155;
  // 2^256, 2^-256
  public static final double POWER_256 = 1.157920892373162E77;
  public static final double POWER_MINUS_256 = 8.636168555094445E-78;
  // 2^128, 2^-128
  public static final double POWER_128 = 3.4028236692093846E38;
  public static final double POWER_MINUS_128 = 2.9387358770557188E-39;
  // 2^64, 2^-64
  public static final double POWER_64 = 18446744073709551616.0;
  public static final double POWER_MINUS_64 = 5.421010862427522E-20;
  // 2^52, 2^-52
  public static final double POWER_52 = 4503599627370496.0;
  public static final double POWER_MINUS_52 = 2.220446049250313E-16;
  // 2^32, 2^-32
  public static final double POWER_32 = 4294967296.0;
  public static final double POWER_MINUS_32 = 2.3283064365386963E-10;
  // 2^31
  public static final double POWER_31 = 2147483648.0;
  // 2^20, 2^-20
  public static final double POWER_20 = 1048576.0;
  public static final double POWER_MINUS_20 = 9.5367431640625E-7;
  // 2^16, 2^-16
  public static final double POWER_16 = 65536.0;
  public static final double POWER_MINUS_16 = 0.0000152587890625;
  // 2^8, 2^-8
  public static final double POWER_8 = 256.0;
  public static final double POWER_MINUS_8 = 0.00390625;
  // 2^4, 2^-4
  public static final double POWER_4 = 16.0;
  public static final double POWER_MINUS_4 = 0.0625;
  // 2^2, 2^-2
  public static final double POWER_2 = 4.0;
  public static final double POWER_MINUS_2 = 0.25;
  // 2^1, 2^-1
  public static final double POWER_1 = 2.0;
  public static final double POWER_MINUS_1 = 0.5;
  // 2^-1022 (smallest double non-denorm)
  public static final double POWER_MINUS_1022 = 2.2250738585072014E-308;

  private static class PowersTable {
    private static final double[] powers = {
      POWER_512, POWER_256, POWER_128, POWER_64, POWER_32, POWER_16, POWER_8, POWER_4, POWER_2,
      POWER_1
    };
  ...
  public DoubleHelper(double value) {
    /*
     * Call to $createDouble(value) must be here so that the method is
     * referenced and not pruned before new Double(value) is replaced by
     * $createDouble(value) by RewriteConstructorCallsForUnboxedTypes.
     */
    // $createDouble(value);
  }

  public DoubleHelper(String s) {
    /*
     * Call to $createDouble(value) must be here so that the method is
     * referenced and not pruned before new Double(value) is replaced by
     * $createDouble(value) by RewriteConstructorCallsForUnboxedTypes.
  ...
  @Override
  public int compareTo(DoubleHelper b) {
  ...
  private static double unsafeCast(Object instance) {
