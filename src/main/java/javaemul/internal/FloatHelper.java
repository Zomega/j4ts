...
public final class FloatHelper extends NumberHelper implements Comparable<FloatHelper> {
  ...
  public static int compare(float x, float y) {
    return DoubleHelper.compare(x, y);
  }
  ...
  public static int floatToIntBits(float value) {
    ...
    // mantissa.
    long l = DoubleHelper.doubleToLongBits((double) value);
  ...
  public static float intBitsToFloat(int bits) {
    ...
    bits64 |= ((long) bits) << 29;
    return (float) DoubleHelper.longBitsToDouble(bits64);
  }

  public static boolean isInfinite(float x) {
    return DoubleHelper.isInfinite(x);
  }

  public static boolean isNaN(float x) {
    return DoubleHelper.isNaN(x);
  }
  ...
  public FloatHelper(double value) {
    this.value = (float) value;
  }

  public FloatHelper(float value) {
    this.value = value;
  }

  public FloatHelper(String s) {
    value = parseFloat(s);
  }
  ...
  @Override
  public int compareTo(FloatHelper b) {
  ...
  public boolean equals(Object o) {
    return (o instanceof FloatHelper) && (((FloatHelper) o).value == value);
  }
